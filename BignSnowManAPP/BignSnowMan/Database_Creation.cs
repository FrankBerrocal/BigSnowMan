        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(builder.ConnectionString))
                {
                    ...
                    sb.Append("     CRC_CostRecord_KA_KnowledgeArea_ID INT NOT NULL, ");
                    sb.Append("     CRC_CostRecord_CV_CostVariance_ID INT NOT NULL, ");
                    sb.Append("     CRC_CostRecord_SV_ScheduleVariance_ID INT NOT NULL,");
                    sb.Append("     CRC_CostRecord_VAC_VarianceAtCompletion_ID  INT NOT NULL, ");
                    sb.Append("     CRC_CostRecord_CPI_CostPerformanceIndex_ID  INT NOT NULL, ");
                    sb.Append("     CRC_CostRecord_SPI_SchedulePerformanceIndex_ID  INT NOT NULL, ");
                    sb.Append("     CRC_CostRecord_EAC_EstimateAtCompletion_ID  INT NOT NULL, ");
                    sb.Append("     CRC_CostRecord_ETC_EstimateToComplete_ID  INT NOT NULL, ");
                    sb.Append("     CRC_CostRecord_TCPI_ToCompletePerformanceIndex_ID  INT NOT NULL ");

                    //foreign keys
                    sb.Append("     CONSTRAINT FK_CRC_CostRecord_tbl_KA_KnowledgeArea_ID FOREIGN KEY (CRC_CostRecord_KA_KnowledgeArea_ID) ");
                    ...
                    sb.Append("     CRP_CostReport_ID INT NOT NULL PRIMARY KEY,  ");
                    sb.Append("     CRP_CostReport_DATE DATETIME, ");
                    ...
                    sb.Append("     WP_WorkPackage_StartDate DATETIME, ");
                    sb.Append("     WP_WorkPackage_EndDate DATETIME, ");
                    sb.Append("     WP_WorkPackage_Name VARCHAR(20), ");
                    sb.Append("     WP_WorkPackage_Description VARCHAR(100), ");
                    sb.Append("     WP_WorkPackage_TC_TotalCost_ID INT NOT NULL, ");
                    sb.Append("     WP_WorkPackage_ST_Status_ID INT NOT NULL ");
                    ...
                    sb.Append("     WBS_WorkBreakdown_ID INT NOT NULL PRIMARY KEY,  ");
                    ...
                    sb.Append("     RR_RequirementRecord_ID INT NOT NULL PRIMARY KEY,  ");
                    ...
                    sb.Append("     TM_TraceabilityMatrix_ID INT NOT NULL PRIMARY KEY,  ");
                    ...
                    sb.Append("     PJ_Project_CRP_CostReport_ID INT NOT NULL, ");
                    sb.Append("     PJ_Project_WBS_WorkBreakdown_ID INT NOT NULL, ");
                    sb.Append("     PJ_Project_TM_TraceabilityMatrix_ID INT NOT NULL, ");
                    sb.Append("     PJ_Project_TM__ST_Status_ID INT NOT NULL ");
                    ...
                    sb.Append("     CONSTRAINT FK_PJ_Project_tbl_ST_Status_ID  FOREIGN KEY (PJ_Project_TM__ST_Status_ID) ");
                    sb.Append("         REFERENCES Project.ST_Status_tbl (ST_Status_ID)");
                    sb.Append("         ON DELETE NO ACTION ");
                    sb.Append("         ON UPDATE NO ACTION ");
